...
const GUIDE_COPY = {
  ja: {
    ...
    sudoku: {
      title: '一意解を保つ問題を作る',
      intro: '最初に完成した 9 × 9 の盤面を作り、数字を1つずつ抜きます。数字を抜くたびにAlgorithm X / Dancing Linksで解を最大2個まで数え、解が1個のときだけ採用します。',
      flowLabel: '数独生成の流れ',
      ...
      rows: [['入門', '50', '1候補／裸のシングルだけで完走'], ['やさしい', '42', '1候補／裸・隠れシングルだけで完走'], ['ふつう', '34', '最大10候補／探索なし・rating 100〜200'], ['むずかしい', '28', '最大10候補／高度手筋・探索なし・150〜300'], ['エキスパート', '24', '10候補／rating最大']],
      rating: 'ふつうとむずかしいは目標ratingへ入った時点で採用し、10候補で未達なら探索なしを優先して目標帯に最も近い問題を選びます。エキスパートは探索量も含め、10候補でratingが最大の問題を採用します。',
      futureTitle: '再現できる問題生成',
      future: '一意解判定にはAlgorithm X / Dancing Linksを使用します。難易度とseedは共有URLへ保存されるため、同じ問題をもう一度生成できます。',
    },
    mines: {
  ...
  en: {
    ...
    sudoku: {
      title: 'Build puzzles while preserving one solution',
      intro: 'The generator first creates a solved 9 × 9 board, then removes clues one at a time. After every removal, Algorithm X / Dancing Links counts up to two solutions and keeps only uniquely solvable boards.',
      ...
      rows: [['Beginner', '50', '1 candidate / naked singles only'], ['Easy', '42', '1 candidate / naked and hidden singles only'], ['Normal', '34', 'up to 10 / search-free rating 100–200'], ['Hard', '28', 'up to 10 / advanced, search-free, 150–300'], ['Expert', '24', 'highest rating of 10 candidates']],
      rating: 'Normal and Hard stop when a candidate reaches the target; after 10 misses, they prefer a search-free puzzle closest to the range. Expert selects the highest rating from 10 candidates, including the remaining search effort.',
      futureTitle: 'Reproducible puzzle generation',
      future: 'Uniqueness uses Algorithm X / Dancing Links. Difficulty and seed are preserved in shared URLs so the same puzzle can be generated again.',
    },
    mines: {
