    ...
    <article className="guide-page">
      ...
      <section id="mines" className="guide-section">
        ...
        <div>
          ...
          <p>
            盤面を開いた瞬間に、選んだマスと周囲 8 マスを安全領域として地雷を配置します。空白マスからは幅優先探索で周囲を開きます。右クリックまたは長押しでは、旗、?、解除の順にマーカーを切り替えます。共有 URL には seed と最初の 1 手を記録するため、受け取った側でも同じ初期展開とスコアを再現できます。
          </p>
          <h3>公平性を先に定義する</h3>
          <p>
