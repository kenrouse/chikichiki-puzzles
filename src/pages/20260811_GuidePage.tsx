...
const GUIDE_COPY = {
  ja: {
    ...
    sudoku: {
      ...
      rating: '入門は裸のシングルだけで完走できることを保証します。ふつう、むずかしい、エキスパートは2、3、6候補から高度手筋と残存探索量を含むratingが最大の問題を選びます。',
  ...
  en: {
    ...
    sudoku: {
      ...
      rating: 'Beginner guarantees completion by naked singles. Normal, Hard, and Expert select the highest rating from 2, 3, and 6 candidates, including advanced techniques and remaining search effort.',
